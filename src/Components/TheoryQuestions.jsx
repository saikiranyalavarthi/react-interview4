...
import React from 'react';
  ...
  const Questions =()=>{
    ...
    <p><b style={{color:"red",fontSize:"20px"}}>1. What is Context api</b></p>
    ...
    <p><b style={{color:"red",fontSize:"20px"}}>2.Difference between callback and useCallback Hook ?</b></p>
    <p> UseCallback:
    ...
    <p><b style={{color:"red",fontSize:"20px"}}>3.What is Props Drilling Concept ?What is State Uplifting ?</b></p>
    <p>Prop drilling: Is the unofficial term for passing data through several nested children components, in a bid to deliver this data to a deeply-nested component. 
      ...
      <p> state Uplifting:As we know, every component in React has its own state.
       ...
       <p><b style={{color:"red",fontSize:"20px"}}>4.Difference between useEffect and useContext ?</b></p>
       <p>
